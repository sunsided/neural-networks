...
namespace Widemeadows.MachineLearning.Neural.Cost
{
    ...
    /// Class LogisticCost.
    /// </summary>
    public sealed class LogisticCost : ICostGradient
    {
        /// <summary>
        /// The backpropagation instance
        /// </summary>
        [NotNull]
        private readonly IBackpropagation _backpropagation;

        /// <summary>
        /// Initializes a new instance of the <see cref="LogisticCost"/> class.
        /// </summary>
        /// <param name="backpropagation">The backpropagation.</param>
        public LogisticCost([NotNull] IBackpropagation backpropagation) // TODO this really is the wrong way around ...
        {
        ...
        /// <returns>ErrorGradient.</returns>
        [Pure]
        private ErrorGradient CalculateErrorGradient([NotNull] LinkedListNode<FeedforwardResult> resultNode, [NotNull] Vector<float> weightErrors)
        {
        ...
        /// <returns>System.Single.</returns>
        [Pure, DebuggerStepThrough]
        public CostGradient CalculateCostAndGradient(Network network, IReadOnlyCollection<TrainingExample> trainingSet, float lambda)
        {
            return lambda > 0
        ...
        /// <returns>System.Single.</returns>
        [Pure]
        private CostGradient BatchCalculateCostAndGradientUnregularized([NotNull] Network network, [NotNull] IReadOnlyCollection<TrainingExample> trainingSet)
        {
            ...
            return new CostGradient(cost, gradientDictionary);
        }
        ...
        [Pure]
        private CostGradient OnlineCalculateCostAndGradientUnregularized([NotNull] Network network, TrainingExample example)
        {
            ...
            while (layer.Previous.Type != LayerType.Input)
            {
                ...
                var delta = backprop.Backpropagate(layer, feedforwardResult, error);
            ...
            return new CostGradient(j, gradients);
        }
        ...
        /// <returns>System.Single.</returns>
        [Pure]
        private CostGradient BatchCalculateCostAndGradientRegularized([NotNull] Network network, [NotNull] IReadOnlyCollection<TrainingExample> trainingSet, float lambda)
        {
            ...
            return new CostGradient(regularizedCost, regularizedGradient);
        }
